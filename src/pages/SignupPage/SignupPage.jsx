...
function SignupPage() {
    ...
    const [ username, userNameChange, usernameMessage, setUssernameValue, setUsernameMessage ] = useInput("username");
    const [ password, passwordChange, passwordMessage  ] = useInput("password");
    const [ checkPassword, checkPasswordChange ] = useInput("chekPassword");
    ...
    const handleSignupSubmit = () => {
        ...
        if(chekFlags.includes("error") || chekFlags.includes(undefined) || chekFlags.includes(null)) {
